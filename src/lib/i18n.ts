...
export const copy = {
  en: {
    ...
    puzzle: {
      ...
      reset: 'Reset puzzle',
      resetTitle: 'Reset',
      resetConfirm: 'Reset the puzzle? All placed tiles will be cleared.',
      resetColumnWidths: 'Reset column widths',
      resetColumnWidthsTitle: 'Reset widths',
  ...
  zh: {
    ...
    puzzle: {
      ...
      reset: '重置拼图',
      resetTitle: '重置',
      resetConfirm: '重置拼图？所有已放置的卡片都会被清除。',
      resetColumnWidths: '重置栏宽',
      resetColumnWidthsTitle: '重置栏宽',
      resizeColumn: '调整栏宽',
      selected: '已选',
